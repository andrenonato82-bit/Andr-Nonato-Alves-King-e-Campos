...
export const CONTEUDO_MEMORIA: ContentMemory = {
  ...
  locations: [
    // --- BAIRROS ---
    {
      ...
      category: 'Bairro',
      // Imagem temática de rua residencial antiga
    ...
    },
    {
      ...
      category: 'Bairro',
      // Imagem temática de bairro
      imageUrl: 'https://images.unsplash.com/photo-1544984243-ec75aa96755e?q=80&w=1000&auto=format&fit=crop',
    ...
    // --- EDIFÍCIOS PÚBLICOS ---
    {
      ...
      // Foto real do Palácio (Wikimedia Commons)
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Pal%C3%A1cio_Senador_H%C3%A9lio_Campos_-_2024.jpg/800px-Pal%C3%A1cio_Senador_H%C3%A9lio_Campos_-_2024.jpg',
    ...
    },
    {
      ...
      title: 'Ginásio de Esportes Hélio Campos',
      category: 'Edifício Público',
      // Imagem temática de complexo esportivo
      imageUrl: 'https://images.unsplash.com/photo-1517482484969-95a287f39429?q=80&w=1000&auto=format&fit=crop',
    ...
    },
    {
      ...
      category: 'Edifício Público',
      // Imagem temática de hospital/saúde pública
    ...
    },
    {
      ...
      category: 'Edifício Público',
      // Imagem do aeroporto ou aviação
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ee/Aeroporto_Internacional_de_Boa_Vista_-_Atlas_Brasil_Cantanhede.jpg',
    ...
    // --- PRAÇAS ---
    {
      ...
      category: 'Praça',
      // Imagem genérica de praça com busto/monumento
      imageUrl: 'https://images.unsplash.com/photo-1596954261073-61e8880498b3?q=80&w=1000&auto=format&fit=crop',
    ...
    // --- ESCOLAS ---
    {
      ...
      category: 'Escola',
      // Imagem temática de escola pública
    ...
    },
    {
      ...
      category: 'Escola',
      // Imagem temática de livros/educação
      imageUrl: 'https://images.unsplash.com/photo-1544396821-4dd40b938ad3?q=80&w=1000&auto=format&fit=crop',
    ...
    },
    {
      ...
      category: 'Logradouro',
      imageUrl: 'https://images.unsplash.com/photo-1578335336043-447547d25e4c?q=80&w=1000&auto=format&fit=crop',
    ...
    },
    {
      ...
      category: 'Logradouro',
      imageUrl: 'https://images.unsplash.com/photo-1616432043562-3671ea2e5242?q=80&w=1000&auto=format&fit=crop',
    ...
    // --- OUTROS (Mantendo alguns essenciais) ---
    {
      ...
      category: 'Monumento',
      // Foto real do Monumento (Wikimedia Commons)
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Monumento_ao_Garimpeiro.jpg/800px-Monumento_ao_Garimpeiro.jpg',
